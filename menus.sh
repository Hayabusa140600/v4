...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/Hayabusa140600/permission/main/ipmini > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/Hayabusa140600/permission/main/ipmini | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/Hayabusa140600/permission/main/ipmini | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/Hayabusa140600/permission/main/ipmini | grep $MYIP | awk '{print $3}')
fi
...
echo -e "║\e[1;37m[•3]\e[0m \e[1;33mᴠʟᴇꜱꜱ\033[0m"       
echo -e "║\e[1;37m[•4]\e[0m \e[1;33mᴛʀᴏᴊᴀɴ-ɢᴏ\033[0m"
echo -e "║\e[1;37m[•5]\e[0m \e[1;33mᴛʀᴏᴊᴀɴ-ᴡꜱ\033[0m"
echo -e "╠═════════════════════════════════════════════╣" | lolcat     
echo -e "║\e[1;36m[06]\e[0m \e[1;36m𝘾𝙡𝙚𝙖𝙧 𝙨𝙖𝙢𝙥𝙖𝙝 𝙧𝙖𝙢\033[0m"
echo -e "║\e[1;36m[07]\e[0m \e[1;36m𝙍𝙚𝙨𝙩𝙖𝙧𝙩 𝙨𝙚𝙧𝙫𝙞𝙘𝙚$NC\033[0m"
echo -e "║\e[1;36m[08]\e[0m \e[1;36m𝙎𝙨𝙝 𝙖𝙘𝙩𝙞𝙫𝙚$NC\033[0m"
echo -e "║\e[1;36m[09]\e[0m \e[1;36m𝙎𝙚𝙩 𝙥𝙖𝙨𝙨𝙬𝙤𝙧𝙙 𝙫𝙥𝙨$NC\033[0m"
echo -e "║\e[1;36m[10]\e[0m \e[1;36m𝙎𝙚𝙩 𝙧𝙚𝙗𝙤𝙤𝙩${NC}\033[0m"
